...
class Affiliate_Links_Pro_Popular_Links extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'The most popular affiliate links on your site', 'affiliate-links' ),
		);

		$this->stat_instance = Affiliate_Links_Pro_Stats::get_instance();

		parent::__construct( 'affiliate-links-popular', esc_html__( 'Popular Affiliate Links', 'affiliate-links' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Popular Links', 'affiliate-links' ) : $instance['title'], $instance, $this->id_base );
